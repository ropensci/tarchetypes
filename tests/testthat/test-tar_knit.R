tar_test("tar_knit() works", suppressMessages({
...
tar_test("tar_knit() warns about tar_read_raw()", suppressMessages({
  on.exit(unlink(c("_targets*", "report.*"), recursive = TRUE))
  lines <- c(
    "---",
    "title: report",
...
tar_test("tar_knit() warns about tar_load_raw()", suppressMessages({
  on.exit(unlink(c("_targets*", "report.*"), recursive = TRUE))
  lines <- c(
    "---",
    "title: report",
