...
The `tarchetypes` R package is a collection of general-purpose utilities for [`targets`](https://github.com/wlandau/targets). These utilities concisely express common kinds of targets to help build more elegant pipelines.
