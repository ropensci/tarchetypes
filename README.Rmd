...
If you define a target with `tar_group_by()`, all downstream dynamic targets will automatically branch over the row groups you define with `dplyr::group_by()`-like syntax.
